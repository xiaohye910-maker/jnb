...
use Autoship\Services\QPilot\Implementations\FeatureFlagManagement;
...
class QPilotServiceClient implements QPilotServiceInterface {
	 ...
	 *
	 * @var FeatureFlagManagement
	 */
	private FeatureFlagManagement $feature_flag_management;
	...
	public function __construct( string $api_url ) {
		...
		$this->feature_flag_management = new Implementations\FeatureFlagManagement( $this->api_client );
	}
	...
	public function get_feature_flags(): array {
		return $this->feature_flag_management->get_feature_flags();
	}
	...
	public function get_site_feature_flags(): array {
		return $this->feature_flag_management->get_site_feature_flags();
	}
