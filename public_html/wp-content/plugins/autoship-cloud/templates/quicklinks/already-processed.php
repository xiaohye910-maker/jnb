<?php
/**
 * QuickLink Already Processed Template (Shopify-aligned).
 *
 * Displays when a confirmation has already been used (double-submit protection).
 * This template can be overridden by copying it to:
 * yourtheme/autoship/quicklinks/already-processed.php
 *
 * @package Autoship
 * @since   3.2.0
 *
 * @var string                                            $status                 The confirmation status.
...
$status_display_text = array(
        QuickLinkConfirmation::STATUS_EXECUTED  => __( 'processed', 'autoship' ),
        QuickLinkConfirmation::STATUS_FAILED    => __( 'failed', 'autoship' ),
        QuickLinkConfirmation::STATUS_CANCELLED => __( 'cancelled', 'autoship' ),
        QuickLinkConfirmation::STATUS_EXPIRED   => __( 'expired', 'autoship' ),
);

$status_text = isset( $status_display_text[ $status ] ) ? $status_display_text[ $status ] : __( 'processed', 'autoship' );
?>
<!DOCTYPE html>
...
<head>
    ...
    <title><?php echo esc_html( sprintf( __( 'Already Processed - %s', 'autoship' ), $site_name ) ); ?></title>
...
<div class="processed-card">
    ...
    <p class="message-text">
        <?php
        printf(
        /* translators: %s: status text (e.g., "processed", "cancelled") */
                esc_html__( 'This confirmation has already been %s.', 'autoship' ),
    ...
    <p class="message-subtext">
        <?php esc_html_e( 'You cannot process the same confirmation multiple times for security reasons.', 'autoship' ); ?>
    </p>
    ...
    <div class="help-box">
        ...
        <ul>
            <li><?php esc_html_e( 'Visit your account to manage your subscriptions', 'autoship' ); ?></li>
            <li><?php esc_html_e( 'Check your email for the original confirmation result', 'autoship' ); ?></li>
