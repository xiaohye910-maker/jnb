<?php
/**
 * QuickLink Error Template (Shopify-aligned).
 *
 * Displays error message when QuickLink processing fails.
 * This template can be overridden by copying it to:
 * yourtheme/autoship/quicklinks/error.php
 *
 * @package Autoship
 * @since   3.2.0
 *
 * @var string      $message                The error message to display.
...
<head>
    ...
    <title><?php echo esc_html( sprintf( __( 'Action Failed - %s', 'autoship' ), $site_name ) ); ?></title>
...
<div class="error-card">
    <div class="card-content">
        ...
        <div class="help-box">
            ...
            <ul>
                <li><?php esc_html_e( 'Try accessing the link again from your original email', 'autoship' ); ?></li>
                <li><?php esc_html_e( 'Check if you are logged into your account', 'autoship' ); ?></li>
                <li><?php esc_html_e( 'Manage your subscription directly from your account dashboard', 'autoship' ); ?></li>
                <li><?php esc_html_e( 'Contact our support team if the issue persists', 'autoship' ); ?></li>
            </ul>
        </div>
