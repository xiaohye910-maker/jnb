<?php
/**
 * QuickLink Expired Template (Shopify-aligned).
 *
 * Displays a message when a QuickLink confirmation has expired.
 * This template can be overridden by copying it to:
 * yourtheme/autoship/quicklinks/expired2.php
 *
 * @package Autoship
 * @since   3.2.0
 *
 * @var string      $message               The expiration message.
...
<head>
    ...
    <title><?php echo esc_html( sprintf( __( 'Link Expired - %s', 'autoship' ), $site_name ) ); ?></title>
...
<div class="expired-card">
    ...
    <p class="message-text">
        <?php esc_html_e( 'This confirmation link has expired after 30 minutes.', 'autoship' ); ?>
    </p>

    <p class="message-subtext">
        <?php esc_html_e( 'For your security, confirmation links expire after a short period.', 'autoship' ); ?>
    </p>
    ...
    <div class="help-box">
        ...
        <ul>
            <li><?php esc_html_e( 'Request a new action link from your email', 'autoship' ); ?></li>
            <li><?php esc_html_e( 'Visit your account to manage your subscription', 'autoship' ); ?></li>
            <li><?php esc_html_e( 'Contact support if you need assistance', 'autoship' ); ?></li>
        </ul>
    </div>
    ...
    <div class="action-buttons">
        <?php if ( is_user_logged_in() && function_exists( 'wc_get_page_permalink' ) ) : ?>
            ...
            <a href="<?php echo esc_url( home_url() ); ?>" class="account-link">
        ...
        <?php else : ?>
            ...
            <a href="<?php echo esc_url( wp_login_url( home_url() ) ); ?>" class="account-link">
                <?php esc_html_e( 'Sign in to your account', 'autoship' ); ?>
            </a>
        <?php endif; ?>
    </div>
