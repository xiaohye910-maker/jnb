<?php
/**
 * QuickLink Rate Limited Template (Shopify-aligned).
 *
 * Displays rate limit message when too many requests have been made.
 * This template can be overridden by copying it to:
 * yourtheme/autoship/quicklinks/rate-limited2.php
 *
 * @package Autoship
 * @since   3.2.0
 *
 * @var string      $message               The rate limit message to display.
 * @var int         $retry_after           Seconds until retry is allowed.
...
<head>
    ...
    <title><?php echo esc_html( sprintf( __( 'Please Wait - %s', 'autoship' ), $site_name ) ); ?></title>
...
<div class="rate-limit-card">
    ...
    <div class="countdown-box">
        <span id="countdown" data-seconds="<?php echo absint( $retry_after ); ?>"><?php echo absint( $retry_after ); ?></span>
        <div class="countdown-label"><?php esc_html_e( 'Seconds Remaining', 'autoship' ); ?></div>
    </div>

    <!-- Auto-reload notice -->
    <p class="auto-reload-notice">
        <?php esc_html_e( 'This page will automatically reload when you can try again.', 'autoship' ); ?>
    </p>
    ...
    <div class="info-box">
        ...
        <ul>
            <li><?php esc_html_e( 'Too many requests were made in a short time', 'autoship' ); ?></li>
            <li><?php esc_html_e( 'This helps protect against automated attacks', 'autoship' ); ?></li>
            <li><?php esc_html_e( 'You can retry once the countdown reaches zero', 'autoship' ); ?></li>
        </ul>
    </div>
...
<script>
    (function() {
        ...
        var remaining = parseInt(countdownEl.getAttribute('data-seconds'), 10);
