...
*/
$skin = apply_filters(
	'autoship_schedule_order_add_item_meta_skin',
	array(
		'conatiner' => '',
		'meta_item' => '',
		'sku'       => '',
...
?>
<div class="autoship-scheduled-order-item-meta <?php echo esc_attr( $skin['conatiner'] ); ?>">
	<?php foreach ( $meta_data as $value ) : ?>
	<div class="autoship-meta-item <?php echo esc_attr( $skin['meta_item'] ); ?>">
		<?php
