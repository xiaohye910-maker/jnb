...
define( 'Autoship_Version', '2.10.5.3' ); // phpcs:ignore Generic.NamingConventions.UpperCaseConstantName.ConstantNotUpperCase
...
function autoship_payment_requirement_notice() {
	...
	if ( Autoship\Core\FeatureManager::is_enabled( 'quicklaunch' ) ) {
