...
<div class="autoship-schedule-info-dialog">
	...
	<?php autoship_generate_modal( 'autoship_schedule_info_dialog_modal', wp_kses_post( $options['autoship_product_info_html'] ), 'customer-modal ' . $options['autoship_product_info_modal_size'], $footer, 'modal' === $options['autoship_product_info_display'] ); ?>
