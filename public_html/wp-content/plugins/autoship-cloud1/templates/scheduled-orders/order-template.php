...
$skin = apply_filters(
	'autoship_scheduled_order_edit_order_template_skin',
	array(
		'container' => '',
	)
);
...
<div class="<?php echo esc_attr( $skin['container'] ); ?> <?php echo apply_filters( 'autoship_edit_scheduled_order_forms_classes', 'autoship-scheduled-order-template', $autoship_order, $customer_id, $autoship_customer_id, $autoship_order_id ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>">
