...
class SenderToOctolize implements \WPDesk_Tracker_Sender
{
    ...
    {
        \FSProVendor\WPDesk_Logger_Factory::log_message("Target URL: " . $this->get_api_url(), 'octolize-sender', \FSProVendor\WPDesk_Logger::DEBUG);
        ...
        if ($response instanceof \WP_Error) {
            throw new \FSProVendor\WPDesk_Tracker_Sender_Exception_WpError('Payload send error', $response);
        } else {
            return $response;
        }
    }
