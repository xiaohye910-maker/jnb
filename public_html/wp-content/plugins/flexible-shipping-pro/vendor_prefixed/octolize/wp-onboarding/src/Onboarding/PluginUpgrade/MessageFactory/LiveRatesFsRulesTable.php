...
namespace FSProVendor\Octolize\Onboarding\PluginUpgrade\MessageFactory;
...
class LiveRatesFsRulesTable
{
    ...
    {
        return new PluginUpgradeMessage($plugin_version, trailingslashit($plugin_url) . 'vendor_prefixed/octolize/wp-onboarding/assets/images/icon-complex-solution.svg', __('We\'ve added integration with Flexible Shipping Table Rate', 'flexible-shipping-pro'), sprintf(
