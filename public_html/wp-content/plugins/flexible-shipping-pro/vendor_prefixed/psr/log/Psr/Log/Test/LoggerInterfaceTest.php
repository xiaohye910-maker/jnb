...
namespace FSProVendor\Psr\Log\Test;

use FSProVendor\Psr\Log\LoggerInterface;
use FSProVendor\Psr\Log\LogLevel;
use FSProVendor\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FSProVendor\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FSProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FSProVendor\Psr\Log\Test\DummyTest', array('__toString'));
        }
