        ...
        public function are_requirements_met()
        {
            ...
            foreach ($this->plugin_require as $name => $plugin_info) {
                if ($this->is_currently_updated($name)) {
                    ...
                    $this->notices[] = $this->prepare_notice_message(\sprintf(\__('The &#8220;%s&#8221; plugin is temporarily disabled since the required %s plugin is being upgraded.', 'flexible-shipping-pro'), $this->plugin_name, $nice_name, $nice_name));
                }
            }
