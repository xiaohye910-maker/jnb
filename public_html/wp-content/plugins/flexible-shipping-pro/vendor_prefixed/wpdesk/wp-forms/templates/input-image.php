...
?>">
			<?php 
\esc_html_e('Set image', 'flexible-shipping-pro');
?>
		</a>
...
?>" href="#">
			<?php 
\esc_html_e('Remove image', 'flexible-shipping-pro');
?>
		</a>
	</p>
</div>
...
?>' ),
		...
		addImgLink.on( 'click', function ( event ) {
			...
			frame = wp.media( {
				title: "<?php 
\esc_html_e('Select or Upload Media', 'flexible-shipping-pro');
?>",
				button: {
					text: "<?php 
\esc_html_e('Use this media', 'flexible-shipping-pro');
?>"
				},
				library: {
					type: ['image']
