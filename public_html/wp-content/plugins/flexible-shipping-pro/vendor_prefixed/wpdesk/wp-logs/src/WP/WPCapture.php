...
namespace FSProVendor\WPDesk\Logger\WP;
...
class WPCapture
{
    ...
    {
        new \FSProVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create directory %s or this directory is not writeable!', 'flexible-shipping-pro'),
            $dir
        ), \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
     * Add notice for file.
     *
    ...
    private function add_notice_for_file($file)
    {
        new \FSProVendor\WPDesk\Notice\Notice(sprintf(
            // Translators: directory.
            __('Can not enable WP Desk Debug log! Cannot create file %s!', 'flexible-shipping-pro'),
            $file
        ), \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR);
    }
    /**
