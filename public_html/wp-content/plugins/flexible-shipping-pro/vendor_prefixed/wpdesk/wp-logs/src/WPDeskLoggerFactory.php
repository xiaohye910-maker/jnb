...
use FSProVendor\Monolog\Handler\StreamHandler;
use FSProVendor\Psr\Log\LogLevel;
use FSProVendor\WPDesk\Logger\WC\WooCommerceCapture;
use FSProVendor\WPDesk\Logger\WP\WPCapture;
/**
...
class WPDeskLoggerFactory extends BasicLoggerFactory
{
    ...
    {
        if (!defined('FSProVendor\WC_LOG_THRESHOLD')) {
            define('FSProVendor\WC_LOG_THRESHOLD', self::LEVEL_WC);
        }
