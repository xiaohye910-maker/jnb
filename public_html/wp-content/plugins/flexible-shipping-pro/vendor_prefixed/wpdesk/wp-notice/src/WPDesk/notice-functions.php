...
if (!\function_exists('FSProVendor\WPDeskInitWpNoticeAjaxHandler')) {
    /**
    ...
    {
        $ajax_handler = new \FSProVendor\WPDesk\Notice\AjaxHandler($assetsUrl);
        $ajax_handler->hooks();
        return $ajax_handler;
    }
}
if (!\function_exists('FSProVendor\wpdesk_init_wp_notice_ajax_handler')) {
    /**
...
if (!\function_exists('FSProVendor\WPDeskWpNotice')) {
    /**
     * Creates Notice.
     *
    ...
    {
        return \FSProVendor\WPDesk\Notice\Factory::notice($noticeContent, $noticeType, $dismissible, $priority);
    }
}
if (!\function_exists('FSProVendor\wpdesk_wp_notice')) {
    /**
     * Creates Notice.
     *
...
if (!\function_exists('FSProVendor\WPDeskWpNoticeInfo')) {
    /**
     * Creates Notice Info.
     *
     * @param string $noticeContent Notice content.
    ...
    {
        return \FSProVendor\WPDesk\Notice\Factory::notice($noticeContent, \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_INFO, $dismissible, $priority);
    }
}
...
if (!\function_exists('FSProVendor\WPDeskWpNoticeError')) {
    /**
    ...
    {
        return \FSProVendor\WPDesk\Notice\Factory::notice($noticeContent, \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_ERROR, $dismissible, $priority);
    }
}
if (!\function_exists('FSProVendor\wpdesk_wp_notice_error')) {
    /**
     * Creates Notice Error.
     *
...
if (!\function_exists('FSProVendor\WPDeskWpNoticeWarning')) {
    /**
    ...
    {
        return \FSProVendor\WPDesk\Notice\Factory::notice($noticeContent, \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_WARNING, $dismissible, $priority);
    }
}
if (!\function_exists('FSProVendor\wpdesk_wp_notice_warning')) {
    /**
     * Creates Notice Warning.
     *
...
if (!\function_exists('FSProVendor\WPDeskWpNoticeSuccess')) {
    /**
    ...
    {
        return \FSProVendor\WPDesk\Notice\Factory::notice($noticeContent, \FSProVendor\WPDesk\Notice\Notice::NOTICE_TYPE_SUCCESS, $dismissible, $priority);
    }
}
...
if (!\function_exists('FSProVendor\WPDeskPermanentDismissibleWpNotice')) {
    /**
    ...
    {
        return \FSProVendor\WPDesk\Notice\Factory::permanentDismissibleNotice($noticeContent, $noticeName, $noticeType, $priority);
    }
}
if (!\function_exists('FSProVendor\wpdesk_permanent_dismissible_wp_notice')) {
    /**
     * Creates Permanent Dismissible Notice.
     *
