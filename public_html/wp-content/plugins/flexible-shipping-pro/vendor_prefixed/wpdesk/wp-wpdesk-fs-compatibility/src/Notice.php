...
class Notice
{
    ...
    public function admin_notices()
    {
        ...
        $additional_info = ' ' . sprintf(__('If the WordPress updater hasn\'t informed you about the newer versions available, please %sfollow these instructions &rarr;%s', 'flexible-shipping-pro'), sprintf('<a href="%s" target="_blank">', __('https://octol.io/fs-2-docs', 'flexible-shipping-pro')), '</a>');
