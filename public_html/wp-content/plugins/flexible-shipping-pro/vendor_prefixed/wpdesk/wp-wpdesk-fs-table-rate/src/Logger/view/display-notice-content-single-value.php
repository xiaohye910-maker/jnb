...
echo \sprintf(\__('Show %1$s', 'flexible-shipping-pro'), $section);
?></button>
	<button class="small hide"><?php 
echo \sprintf(\__('Hide %1$s', 'flexible-shipping-pro'), $section);
?></button>
	<button class="small clipboard"><?php 
echo \sprintf(\__('Copy %1$s', 'flexible-shipping-pro'), $section);
?></button>
	<pre><?php 
