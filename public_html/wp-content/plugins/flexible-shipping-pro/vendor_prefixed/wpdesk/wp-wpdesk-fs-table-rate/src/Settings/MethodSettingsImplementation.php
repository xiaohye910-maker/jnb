...
use FSProVendor\WPDesk\FS\TableRate\CalculationMethodOptions;
...
class MethodSettingsImplementation implements MethodSettings, CanFormatForLog
{
    ...
    {
        $tax_status_options = array('taxable' => __('Taxable', 'flexible-shipping-pro'), 'none' => _x('None', 'Tax status', 'flexible-shipping-pro'));
