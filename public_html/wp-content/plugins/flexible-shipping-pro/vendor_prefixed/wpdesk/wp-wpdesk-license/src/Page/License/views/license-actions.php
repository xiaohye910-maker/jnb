...
<form method="POST">
    <table class="wpdesk_helper_key_table">
        <tr>
            <td><?php 
\esc_html(\__('Key:', 'flexible-shipping-pro'));
?></td>
...
?> /></td>
        ...
        <tr>
            <td><?php 
\esc_html(\__('Email:', 'flexible-shipping-pro'));
?></td>
...
if ($activation_status == 'Deactivated') {
    ...
    echo \esc_html(\__('Activate', 'flexible-shipping-pro'));
    ?></button>
				<?php 
} else {
    ?>
                    <button class="wpdesk_helper_button button"><?php 
    echo \esc_html(\__('Deactivate', 'flexible-shipping-pro'));
    ?></button>
				<?php 
}
?>
