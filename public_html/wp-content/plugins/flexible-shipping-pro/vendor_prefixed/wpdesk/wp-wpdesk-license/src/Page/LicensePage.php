...
use FSProVendor\WPDesk\License\InstalledPlugins;
/**
...
class LicensePage implements Hookable
{
    ...
    {
        add_submenu_page('wpdesk-helper', __('Subscriptions', 'flexible-shipping-pro'), __('Subscriptions', 'flexible-shipping-pro'), 'manage_options', self::PAGE_SLUG, [$this, 'handle_render_wpdesk_licenses_page']);
    }
    /**
    ...
    public function handle_render_wpdesk_licenses_page()
    {
        ...
        if (!class_exists('FSProVendor\WPDesk_Helper_List_Table')) {
