...
async function ensureBearerToken(minValidityMs = 5 * 60 * 1e3) {
  ...
  const bearerToken = getMiGlobal$1("bearer_token");
  const bearerExpires = getMiGlobal$1("bearer_expires");
  ...
  const nonce = getMiGlobal$1("nonce");
  try {
...
const isAddonActive = (addon) => {
  const addons = getMiGlobal$1("addons", {});
  return !!addons[addon];
};
const isAddonInstalled = (addon) => {
  const info = getMiGlobal$1("addons_info", {});
...
const getAddonsPageUrl = () => {
  return getMiGlobal$1("addons_page_url", "/wp-admin/admin.php?page=monsterinsights_settings#/addons");
};
const isAuthed = () => {
  return getMiGlobal$1("authed", false);
};
...
function getUpgradeUrl$1(medium, campaign, url) {
  const upgrade_url = getUrl$1(medium, campaign, url);
  const shareasale_id = getMiGlobal$1("shareasale_id", 0);
  const shareasale_url = getMiGlobal$1("shareasale_url", "");
  if (shareasale_id && "0" !== shareasale_id && shareasale_url) {
    return addQueryArg$1(shareasale_url, "urllink", upgrade_url);
  }
  return upgrade_url;
}
...
const _hoisted_1$3 = { class: "monsterinsights-notificationsv3-single-notification" };
const _hoisted_2$3 = ["innerHTML"];
const _hoisted_3$3 = { class: "monsterinsights-notificationsv3-notification-details" };
const _hoisted_4$2 = { class: "monsterinsights-notificationsv3-notification-title" };
...
const _hoisted_2$2 = { class: "monsterinsights-notificationsv3-sidebar-header-top" };
const _hoisted_3$2 = { class: "monsterinsights-notificationsv3-sidebar-header-top-title" };
...
const HeaderNotifications = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d91b9d00"]]);
...
export {
  ...
  getMiGlobal as a1,
  isAddonActive as a2,
  ensureBearerToken as a3,
  getMonsterInsightsUrl as a4,
  vModelSelect as a5,
  sprintf as a6,
  isAuthed as a7,
  _export_sfc as a8,
  getAddonBasename as a9,
  isSVGTag as aA,
  isMathMLTag as aB,
  ...
  isNetworkAdmin as aL,
  getUrl as aM,
  useErrorHandling as aN,
  getUpgradeUrl as aO,
  getSampleData as aP,
  storeToRefs as aQ,
  onBeforeMount as aR,
  ...
  getMiGlobal$1 as aa,
  isPro as ab,
  isAddonInstalled as ac,
  getAddonsPageUrl as ad,
  getUpgradeUrl$1 as ae,
  getUrl$1 as af,
  useRouter as ag,
  getWidgetSupportForType as ah,
  useRoute as ai,
  onErrorCaptured as aj,
  NOOP as ak,
  extend as al,
  isString as am,
  NO as an,
