...
function setupPinia(app2) {
  const pinia = createPinia();
  app2.use(pinia);
  return pinia;
}
const getMiGlobal$1 = (key, defaultValue = null) => {
...
const sampleDataModules = /* @__PURE__ */ Object.assign({ "../stores/sample-data/custom-dashboard/sample-view.json": () => __vitePreload(() => import("./chunks/sample-view-DCgpbF5N.js"), true ? [] : void 0, import.meta.url), "../stores/sample-data/custom-dashboard/widgets-data.json": () => __vitePreload(() => import("./chunks/widgets-data-TjimP1Ju.js"), true ? [] : void 0, import.meta.url) });
...
function addQueryArg$1(uri, key, value) {
  let hash = "";
...
function getUrl$1(medium, campaign, url) {
  const source = "liteplugin", default_url = "lite/", content = getMiGlobal$1("plugin_version", "1.0.0");
  ...
  url = addQueryArg$1(url, "utm_source", source);
  url = addQueryArg$1(url, "utm_medium", medium);
  url = addQueryArg$1(url, "utm_campaign", campaign);
  url = addQueryArg$1(url, "utm_content", content);
  return url;
}
...
const __vite_glob_0_0 = "data:text/markdown;base64,";
...
const __vite_glob_0_2 = "" + new URL("../assets/logo-exactmetrics-agency.svg", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("../assets/logo-exactmetrics-plus.svg", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("../assets/logo-exactmetrics-pro.svg", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("../assets/logo-exactmetrics.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("../assets/logo-exactmetrics@2x.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("../assets/logo-monsterinsights-agency.svg", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("../assets/logo-monsterinsights-plus.svg", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("../assets/logo-monsterinsights-pro.svg", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("../assets/logo-monsterinsights.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("../assets/logo-monsterinsights@2x.png", import.meta.url).href;
const __vite_glob_0_12 = "" + new URL("../assets/sample-image-exactmetrics.png", import.meta.url).href;
const __vite_glob_0_13 = "" + new URL("../assets/sample-image-monsterinsights.png", import.meta.url).href;
  ...
  setup(__props) {
    ...
    const link = computed(() => {
      if (isProLicensed.value) {
        return getMiGlobal$1("custom_dashboard_url", "#");
      }
      return getUrl$1("logo", "header", "https://www.monsterinsights.com/lite/");
    });
    ...
    const logo2x = computed(() => {
      ...
      if (license.type && isPro()) ;
      const theme = getTheme();
      return new URL((/* @__PURE__ */ Object.assign({ "../../assets/img/logo-exactmetrics@2x.png": __vite_glob_0_6, "../../assets/img/logo-monsterinsights@2x.png": __vite_glob_0_11 }))[`../../assets/img/logo-${theme}@2x.png`], import.meta.url).href + " 2x";
    });
    return (_ctx, _cache) => {
...
const { __ } = wp.i18n;
const fetchNotifications = () => new Promise((resolve2, reject) => {
...
const dismissNotification = (id) => new Promise((resolve2, reject) => {
...
const useNotificationsStore = /* @__PURE__ */ defineStore("notifications", {
  ...
  getters: {
    // The component directly accesses activeNotifications and dismissedNotifications
    // from the store instance after using storeToRefs or via computed properties.
    // So, explicit getters for these might not be strictly needed if the component
    // handles it, but you can add them for consistency if you prefer.
    // Example:
    // getActiveNotifications: (state) => state.activeNotifications,
    // getDismissedNotifications: (state) => state.dismissedNotifications,
    // Renamed to match component usage, and to reflect it checks active notifications
...
const _hoisted_1$4 = { class: "monsterinsights-notificationsv3-single-notification" };
const _hoisted_2$4 = ["innerHTML"];
const _hoisted_3$4 = { class: "monsterinsights-notificationsv3-notification-details" };
const _hoisted_4$3 = { class: "monsterinsights-notificationsv3-notification-title" };
const _hoisted_5$1 = ["innerHTML"];
const _hoisted_6$1 = { class: "monsterinsights-notificationsv3-notification-content" };
const _hoisted_7$1 = ["innerHTML"];
const _hoisted_8$1 = { class: "monsterinsights-notificationsv3-notification-actions" };
const _hoisted_9$1 = ["href", "target", "onClick", "textContent"];
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const installedAndActivated = /* @__PURE__ */ ref(false);
    const processing = /* @__PURE__ */ ref(false);
    const icon = computed(() => {
    ...
    const buttonClass = (type) => {
      return "monsterinsights-button monsterinsights-button-" + type;
    };
    const dismiss = (notificationId) => {
      notificationsStore.dismissNotificationAction(notificationId).then(() => {
        const menu_indicator = document.querySelector(".monsterinsights-menu-notification-indicator");
        if (menu_indicator && notificationsStore.activeNotifications.length === 0) {
          menu_indicator.style.display = "none";
        } else if (menu_indicator) {
          menu_indicator.innerText = notificationsStore.activeNotifications.length;
        }
      });
    };
    const buttonAction = (button_type, callbackurl) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        ...
        createBaseVNode("div", _hoisted_3$4, [
          ...
          createBaseVNode("div", _hoisted_8$1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.notification.btns, (button, button_type) => {
              return openBlock(), createElementBlock("a", {
                key: button_type,
                href: button_type.startsWith("cta_") ? "#" : button.url,
                target: button.is_external ? "_blank" : "_self",
                class: normalizeClass(["monsterinsights-button", buttonClass(button_type)]),
                onClick: ($event) => buttonAction(button_type, button.url),
            ...
            __props.dismissable ? (openBlock(), createElementBlock("span", {
              key: 0,
              onClick: _cache[0] || (_cache[0] = ($event) => dismiss(__props.notification.id)),
...
const _hoisted_1$3 = { class: "monsterinsights-notificationsv3-container" };
const _hoisted_2$3 = { class: "monsterinsights-notificationsv3-sidebar-header-top" };
const _hoisted_3$3 = { class: "monsterinsights-notificationsv3-sidebar-header-top-title" };
const _hoisted_4$2 = ["textContent"];
const _hoisted_5 = ["textContent"];
const _hoisted_6 = { class: "monsterinsights-notificationsv3-sidebar-header-top-actions" };
const _hoisted_7 = ["textContent"];
const _hoisted_8 = ["textContent"];
const _hoisted_9 = { class: "monsterinsights-notificationsv3-sidebar-header-bottom" };
const _hoisted_10 = { class: "monsterinsights-notificationsv3-sidebar-header-bottom-notifications-count" };
const _hoisted_11 = ["textContent"];
const _hoisted_12 = ["textContent"];
const _hoisted_13 = ["textContent"];
const _hoisted_14 = {
  key: 0,
  class: "monsterinsights-notificationsv3-sidebar-header-bottom-actions"
};
...
const _hoisted_17 = {
  key: 0,
  class: "monsterinsights-notificationsv3-no-notifications"
};
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isShowDismissed = /* @__PURE__ */ ref(false);
    const text_inbox = __2("Inbox", "google-analytics-for-wordpress");
    const text_back_to_inbox = __2("Back to Inbox", "google-analytics-for-wordpress");
    const text_view_dismissed = __2("View Dismissed", "google-analytics-for-wordpress");
    const text_notifications = __2("Notifications", "google-analytics-for-wordpress");
    const text_dismiss_all = __2("Dismiss All", "google-analytics-for-wordpress");
    const text_dismissed = __2("Dismissed", "google-analytics-for-wordpress");
    ...
    const closeSidebar = () => {
      isShowDismissed.value = false;
      emit2("close");
    };
    const dismiss = (notificationId) => {
      notificationsStore.dismissNotificationAction(notificationId).then(() => {
        const menu_indicator = document.querySelector(".monsterinsights-menu-notification-indicator");
        if (menu_indicator && activeNotifications.value.length === 0) {
          menu_indicator.style.display = "none";
        } else if (menu_indicator) {
          menu_indicator.innerText = activeNotifications.value.length;
        }
      });
    };
    onMounted(() => {
        ...
        __props.isOpen ? (openBlock(), createElementBlock("div", {
          ...
          createBaseVNode("div", _hoisted_2$3, [
            createBaseVNode("div", _hoisted_3$3, [
              ...
              !isShowDismissed.value ? (openBlock(), createElementBlock("h3", {
                key: 0,
                textContent: toDisplayString(unref(text_inbox))
              }, null, 8, _hoisted_4$2)) : createCommentVNode("", true),
              isShowDismissed.value ? (openBlock(), createElementBlock("h3", {
                key: 1,
                textContent: toDisplayString(unref(text_dismissed))
              }, null, 8, _hoisted_5)) : createCommentVNode("", true)
            ]),
            createBaseVNode("div", _hoisted_6, [
              !isShowDismissed.value ? (openBlock(), createElementBlock("button", {
                key: 0,
                class: "monsterinsights-button",
                onClick: _cache[0] || (_cache[0] = ($event) => isShowDismissed.value = true),
                textContent: toDisplayString(unref(text_view_dismissed))
              }, null, 8, _hoisted_7)) : createCommentVNode("", true),
              isShowDismissed.value ? (openBlock(), createElementBlock("button", {
                key: 1,
                class: "monsterinsights-button",
                onClick: _cache[1] || (_cache[1] = ($event) => isShowDismissed.value = false),
                textContent: toDisplayString(unref(text_back_to_inbox))
          ...
          createBaseVNode("div", _hoisted_9, [
            createBaseVNode("div", _hoisted_10, [
              !isShowDismissed.value ? (openBlock(), createElementBlock("span", {
                key: 0,
                class: "monsterinsights-notificationsv3-inbox-number",
                textContent: toDisplayString(activeNotificationsNumber.value)
              }, null, 8, _hoisted_11)) : createCommentVNode("", true),
              isShowDismissed.value ? (openBlock(), createElementBlock("span", {
                key: 1,
                class: "monsterinsights-notificationsv3-dismissed-number",
                textContent: toDisplayString(dismissedNotificationsNumber.value)
              }, null, 8, _hoisted_12)) : createCommentVNode("", true),
              createBaseVNode("h4", {
                textContent: toDisplayString(unref(text_notifications))
              }, null, 8, _hoisted_13)
            ]),
            !isShowDismissed.value && activeNotificationsNumber.value > 0 ? (openBlock(), createElementBlock("div", _hoisted_14, [
              createBaseVNode("span", {
                onClick: _cache[2] || (_cache[2] = ($event) => dismiss("all")),
                textContent: toDisplayString(unref(text_dismiss_all))
              }, null, 8, _hoisted_15)
            ])) : createCommentVNode("", true)
          ]),
          !isShowDismissed.value ? (openBlock(), createElementBlock("div", _hoisted_16, [
            activeNotificationsNumber.value < 1 ? (openBlock(), createElementBlock("div", _hoisted_17, [
          ...
          isShowDismissed.value ? (openBlock(), createElementBlock("div", _hoisted_19, [
            dismissedNotificationsNumber.value < 1 ? (openBlock(), createElementBlock("div", _hoisted_20, [
...
const _hoisted_1$2 = { class: "mi-header-notifications" };
...
const HeaderNotifications = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d91b9d00"]]);
const _hoisted_1$1 = { class: "monsterinsights-header" };
const _hoisted_2$1 = { class: "monsterinsights-container monsterinsights-header-container" };
const _hoisted_3$1 = { class: "monsterinsights-header-left" };
const _hoisted_4$1 = { class: "monsterinsights-header-right monsterinsights-float-right" };
const _sfc_main$1 = {
  __name: "TheAppHeader",
  setup(__props) {
    return (_ctx, _cache) => {
...
const DashboardList = () => __vitePreload(() => import("./chunks/DashboardList.lite-CaEI9Vb9.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
const DashboardCreate = () => __vitePreload(() => import("./chunks/DashboardCreate-hcZoS4x7.js"), true ? __vite__mapDeps([3,4,1,2,5,6]) : void 0, import.meta.url);
const DashboardEdit = () => __vitePreload(() => import("./chunks/DashboardEdit-B6ZyXTsT.js"), true ? __vite__mapDeps([7,3,4,1,2,5,6]) : void 0, import.meta.url);
const DashboardView = () => __vitePreload(() => import("./chunks/DashboardView-BiCoJOav.js"), true ? __vite__mapDeps([8,4,1,2,5]) : void 0, import.meta.url);
const routes = [
  {
    path: "/",
    redirect: "/dashboards"
...
const stylePromise = __vitePreload(() => Promise.resolve({}), true ? __vite__mapDeps([9]) : void 0, import.meta.url);
...
export {
  ...
  isMathMLTag as S,
  Transition as T,
  parseStringStyle as U,
  makeMap as V,
  generateCodeFrame as W,
  getAugmentedNamespace as X,
  runtimeDom_esmBundler as Y,
  shared_esmBundler as Z,
  __$1 as _,
  openBlock as a,
  onUnmounted as a0,
  ...
  sprintf as ah,
  getMiGlobal as ai,
  getMonsterInsightsUrl as aj,
  isNetworkAdmin as ak,
  getUrl as al,
  useErrorHandling as am,
  getUpgradeUrl as an,
  getSampleData as ao,
  createVNode as b,
