 ...
 */
class WOE_HTMLPurifier_AttrDef_CSS_Ratio extends WOE_HTMLPurifier_AttrDef
{
    /**
     * @param   string               $ratio   Ratio to validate
     * @param   WOE_HTMLPurifier_Config  $config  Configuration options
     * @param   WOE_HTMLPurifier_Context $context Context
     *
     * @return  string|boolean
     *
     * @warning Some contexts do not pass $config, $context. These
     *          variables should not be used without checking WOE_HTMLPurifier_Length
     */
