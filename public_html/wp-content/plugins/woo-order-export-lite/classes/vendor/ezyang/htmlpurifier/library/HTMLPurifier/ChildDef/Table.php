 ...
 */
class WOE_HTMLPurifier_ChildDef_Table extends WOE_HTMLPurifier_ChildDef
{
    /**
     * @type bool
     */
    ...
    public function validateChildren($children, $config, $context)
    {
        ...
        foreach ($children as $node) {
            if ($node instanceof WOE_HTMLPurifier_Node_Comment) {
                $ws_accum[] = $node;
                continue;
            }
            switch ($node->name) {
            ...
            foreach($content as $node) {
                ...
                case 'tr':
                    if ($current_tr_tbody === null) {
                        $current_tr_tbody = new WOE_HTMLPurifier_Node_Element('tbody');
