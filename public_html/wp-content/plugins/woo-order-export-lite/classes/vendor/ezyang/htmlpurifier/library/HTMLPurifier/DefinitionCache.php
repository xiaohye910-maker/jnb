 ...
 */
abstract class WOE_HTMLPurifier_DefinitionCache
{
    /**
     * @type string
     */
     ...
     * @param WOE_HTMLPurifier_Config $config Instance of WOE_HTMLPurifier_Config to test against
     * @return bool
     */
     ...
     * @param WOE_HTMLPurifier_Definition $def Definition object to check
