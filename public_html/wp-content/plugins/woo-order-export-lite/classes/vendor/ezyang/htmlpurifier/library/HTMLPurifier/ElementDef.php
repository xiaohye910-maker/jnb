 ...
 * WOE_HTMLPurifier_HTMLDefinition and WOE_HTMLPurifier_HTMLModule.
 * @note This class is inspected by WOE_HTMLPurifier_Printer_HTMLDefinition.
 *       Please update that class too.
 * @warning If you add new properties to this class, you MUST update
 *          the mergeIn() method.
 */
class WOE_HTMLPurifier_ElementDef
{
    /**
    ...
    /**
     * Associative array of attribute name to WOE_HTMLPurifier_AttrDef.
     * @type array
     * @note Before being processed by WOE_HTMLPurifier_AttrCollections
     *       when modules are finalized during
     *       WOE_HTMLPurifier_HTMLDefinition->setup(), this array may also
     *       contain an array at index 0 that indicates which attribute
     *       collections to load into the full array. It may also
     *       contain string indentifiers in lieu of WOE_HTMLPurifier_AttrDef,
     *       see WOE_HTMLPurifier_AttrTypes on how they are expanded during
     *       WOE_HTMLPurifier_HTMLDefinition->setup() processing.
     */
    public $attr = array();
    ...
    /**
     * List of tags WOE_HTMLPurifier_AttrTransform to be done before validation.
     * @type array
     */
    public $attr_transform_pre = array();

    /**
     * List of tags WOE_HTMLPurifier_AttrTransform to be done after validation.
     * @type array
     */
    public $attr_transform_post = array();

    /**
     * WOE_HTMLPurifier_ChildDef of this tag.
     * @type WOE_HTMLPurifier_ChildDef
     */
    public $child;

    /**
     * Abstract string representation of internal ChildDef rules.
     * @see WOE_HTMLPurifier_ContentSets for how this is parsed and then transformed
     * into an WOE_HTMLPurifier_ChildDef.
     ...
     * WOE_HTMLPurifier_ChildDef_Chameleon. Dynamically set: modules don't
     ...
     * Dynamically populated by WOE_HTMLPurifier_HTMLDefinition::getElement()
     * @type array
     */
    ...
    {
        $def = new WOE_HTMLPurifier_ElementDef();
