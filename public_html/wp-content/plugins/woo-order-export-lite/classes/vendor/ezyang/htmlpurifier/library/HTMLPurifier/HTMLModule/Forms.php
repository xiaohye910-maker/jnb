 ...
 */
class WOE_HTMLPurifier_HTMLModule_Forms extends WOE_HTMLPurifier_HTMLModule
{
    /**
     * @type string
     */
    ...
    public function setup($config)
    {
        ...
        $input->attr_transform_post[] = new WOE_HTMLPurifier_AttrTransform_Input();
        ...
        $textarea->attr_transform_pre[] = new WOE_HTMLPurifier_AttrTransform_Textarea();
