...
class WOE_HTMLPurifier_HTMLModule_Legacy extends WOE_HTMLPurifier_HTMLModule
{
    /**
     * @type string
     */
    ...
    public function setup($config)
    {
        ...
        $li->attr['value'] = new WOE_HTMLPurifier_AttrDef_Integer();
        $li->attr['type'] = 'Enum#s:1,i,I,a,A,disc,square,circle';

        $ol = $this->addBlankElement('ol');
        $ol->attr['compact'] = 'Bool#compact';
        $ol->attr['start'] = new WOE_HTMLPurifier_AttrDef_Integer();
