 ...
 * are best described WOE_HTMLPurifier_Strategy_MakeWellFormed->processToken()
 * documentation.
 *
 * @todo Allow injectors to request a re-run on their output. This
 *       would help if an operation is recursive.
 */
abstract class WOE_HTMLPurifier_Injector
{
     ...
     * @param WOE_HTMLPurifier_Token $current Current token variable.
    ...
    protected function forwardUntilEndToken(&$i, &$current, &$nesting)
    {
        ...
        if ($current instanceof WOE_HTMLPurifier_Token_Start) {
            $nesting++;
        } elseif ($current instanceof WOE_HTMLPurifier_Token_End) {
            if ($nesting <= 0) {
                return false;
            }
            $nesting--;
     ...
     * @param WOE_HTMLPurifier_Token $token Current token variable.
