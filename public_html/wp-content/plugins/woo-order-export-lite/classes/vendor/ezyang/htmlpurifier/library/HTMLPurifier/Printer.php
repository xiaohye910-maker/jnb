...
class WOE_HTMLPurifier_Printer
{
    ...
    protected function start($tag, $attr = array())
    {
        return $this->generator->generateFromToken(
            new WOE_HTMLPurifier_Token_Start($tag, $attr ? $attr : array())
        );
    }
    ...
    {
        return $this->generator->generateFromToken(
            new WOE_HTMLPurifier_Token_End($tag)
        );
    }
    ...
    {
        return $this->generator->generateFromToken(
            new WOE_HTMLPurifier_Token_Empty($tag, $attr)
        );
    }
    ...
    {
        return $this->generator->generateFromToken(
            new WOE_HTMLPurifier_Token_Text($text)
        );
    }
    ...
    {
        $string = WOE_HTMLPurifier_Encoder::cleanUTF8($string);
