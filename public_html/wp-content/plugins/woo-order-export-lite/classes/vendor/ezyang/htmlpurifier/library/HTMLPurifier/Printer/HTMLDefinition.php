...
class WOE_HTMLPurifier_Printer_HTMLDefinition extends WOE_HTMLPurifier_Printer
{

    /**
     * @type WOE_HTMLPurifier_HTMLDefinition, for easy access
     */
    protected $def;
    ...
    public function render($config)
    {
        ...
        $ret .= $this->start('div', array('class' => 'WOE_HTMLPurifier_Printer'));
     ...
     * @param WOE_HTMLPurifier_ChildDef $def WOE_HTMLPurifier_ChildDef of pertinent element
     * @return string
     */
     ...
     * @param array $array Array hash in form of array('attrname' => WOE_HTMLPurifier_AttrDef)
     * @return string
     */
