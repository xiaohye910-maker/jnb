 ...
 */
class WOE_HTMLPurifier_TagTransform_Font extends WOE_HTMLPurifier_TagTransform
{
    /**
     * @type string
     */
     ...
     * @return WOE_HTMLPurifier_Token_End|string
     */
    public function transform($tag, $config, $context)
    {
        if ($tag instanceof WOE_HTMLPurifier_Token_End) {
            $new_tag = clone $tag;
