 ...
 * however.
 */
class WOE_HTMLPurifier_VarParser_Flexible extends WOE_HTMLPurifier_VarParser
{
    /**
     * @param mixed $var
     * @param int $type
            ...
            case self::C_BOOL:
                if (is_int($var) && ($var === 0 || $var === 1)) {
                    ...
                    if ($var == 'on' || $var == 'true' || $var == '1') {
                        ...
                        throw new WOE_HTMLPurifier_VarParserException("Unrecognized value '$var' for $type");
                    }
                }
                return $var;
            case self::ALIST:
