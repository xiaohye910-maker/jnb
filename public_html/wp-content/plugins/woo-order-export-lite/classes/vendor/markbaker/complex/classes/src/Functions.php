...
class Functions
{
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function acos($complex): WOE\Complex
    {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function acosh($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     */
    public static function acot($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function acoth($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function acsc($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function acsch($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function asec($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function asech($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function asin($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        $invsqrt = self::sqrt(Operations::subtract(1, Operations::multiply($complex, $complex)));
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function asinh($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal() && $complex->getReal() > 1) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function atan($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function atanh($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function conjugate($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function cos($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function cosh($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function cot($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function coth($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function csc($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function csch($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            return new Complex(INF);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function exp($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    InvalidArgumentException    If function would result in a division by zero
     */
    public static function inverse($complex): WOE\Complex
    {
     ...
     */
    public static function ln($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
     ...
     * @throws    InvalidArgumentException  If the real and the imaginary parts are both zero
     */
    public static function log2($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            throw new InvalidArgumentException();
     ...
     * @throws    InvalidArgumentException  If the real and the imaginary parts are both zero
     */
    public static function log10($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->getReal() == 0.0 && $complex->getImaginary() == 0.0) {
            throw new InvalidArgumentException();
     ...
     *
     */
    public static function negative($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     */
    public static function pow($complex, $power): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if (!is_numeric($power)) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function sec($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function sech($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function sin($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function sinh($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    Exception        If argument isn't a valid real or complex number.
     */
    public static function sqrt($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
     ...
     * @throws    InvalidArgumentException    If function would result in a division by zero
     */
    public static function tan($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        if ($complex->isReal()) {
     ...
     * @throws    \InvalidArgumentException    If function would result in a division by zero
     */
    public static function tanh($complex): WOE\Complex
    {
        $complex = Complex::validateComplexArgument($complex);
        $real = $complex->getReal();
        $imaginary = $complex->getImaginary();
