...
class Operations
{
     ...
     * @return    \Complex
     */
    public static function add(...$complexValues): WOE\Complex
    {
     ...
     * @return    \Complex
     */
    public static function divideby(...$complexValues): WOE\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
     ...
     * @return    \Complex
     */
    public static function divideinto(...$complexValues): WOE\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
     ...
     * @return    \Complex
     */
    public static function multiply(...$complexValues): WOE\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
     ...
     * @return    \Complex
     */
    public static function subtract(...$complexValues): WOE\Complex
    {
        if (count($complexValues) < 2) {
            throw new \Exception('This function requires at least 2 arguments');
        }
