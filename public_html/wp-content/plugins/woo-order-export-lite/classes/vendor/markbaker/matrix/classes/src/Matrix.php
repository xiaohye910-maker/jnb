...
class Matrix
{
     ...
     * @throws Exception
     */
    public function getRows(int $row, int $rowCount = 1): WOE\Matrix
    {
     ...
     * @throws Exception
     */
    public function getColumns(int $column, int $columnCount = 1): WOE\Matrix
    {
     ...
     * @throws Exception
     */
    public function dropRows(int $row, int $rowCount = 1): WOE\Matrix
    {
     ...
     * @throws Exception
     */
    public function dropColumns(int $column, int $columnCount = 1): WOE\Matrix
    {
