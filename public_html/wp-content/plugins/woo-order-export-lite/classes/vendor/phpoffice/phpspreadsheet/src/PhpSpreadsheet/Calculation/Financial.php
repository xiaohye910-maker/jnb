...
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Amortization;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Coupons;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Depreciation;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Dollar;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\InterestRate;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\TreasuryBill;
/**
 * @deprecated 1.18.0
 */
class Financial
{
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Cumulative::interest($rate, $nper, $pv, $start, $end, $type);
    }
    /**
     * CUMPRINC.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Cumulative::principal($rate, $nper, $pv, $start, $end, $type);
    }
    /**
     * DB.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\Rates::discount($settlement, $maturity, $price, $redemption, $basis);
    }
    /**
     * DOLLARDE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\InterestRate::effective($nominalRate, $periodsPerYear);
    }
    /**
     * FV.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic::futureValue($rate, $nper, $pmt, $pv, $type);
    }
    /**
     * FVSCHEDULE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Single::futureValue($principal, $schedule);
    }
    /**
     * INTRATE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\Rates::interest($settlement, $maturity, $investment, $redemption, $basis);
    }
    /**
     * IPMT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Interest::payment($rate, $per, $nper, $pv, $fv, $type);
    }
    /**
     * IRR.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Variable\Periodic::rate($values, $guess);
    }
    /**
     * ISPMT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Interest::schedulePayment(...$args);
    }
    /**
     * MIRR.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Variable\Periodic::modifiedRate($values, $finance_rate, $reinvestment_rate);
    }
    /**
     * NOMINAL.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic::periods($rate, $pmt, $pv, $fv, $type);
    }
    /**
     * NPV.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Variable\Periodic::presentValue(...$args);
    }
    /**
     * PDURATION.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Single::periods($rate, $pv, $fv);
    }
    /**
     * PMT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Payments::annuity($rate, $nper, $pv, $fv, $type);
    }
    /**
     * PPMT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Payments::interestPayment($rate, $per, $nper, $pv, $fv, $type);
    }
    /**
     * PRICE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic::presentValue($rate, $nper, $pmt, $fv, $type);
    }
    /**
     * RATE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Constant\Periodic\Interest::rate($nper, $pmt, $pv, $fv, $type, $guess);
    }
    /**
     * RECEIVED.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\Securities\Price::received($settlement, $maturity, $investment, $discount, $basis);
    }
    /**
     * RRI.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Single::interestRate($nper, $pv, $fv);
    }
    /**
     * SLN.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Variable\NonPeriodic::rate($values, $dates, $guess);
    }
    /**
     * XNPV.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Financial\CashFlow\Variable\NonPeriodic::presentValue($rate, $values, $dates);
    }
    /**
     * YIELDDISC.
     *
