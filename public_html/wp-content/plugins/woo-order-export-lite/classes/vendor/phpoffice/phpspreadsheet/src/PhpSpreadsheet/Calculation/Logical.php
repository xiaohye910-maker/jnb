...
use WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Boolean;
/**
 * @deprecated 1.17.0
 */
class Logical
{
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Operations::logicalAnd(...$args);
    }
    /**
     * LOGICAL_OR.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Operations::logicalOr(...$args);
    }
    /**
     * LOGICAL_XOR.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Operations::logicalXor(...$args);
    }
    /**
     * NOT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Operations::NOT($logical);
    }
    /**
     * STATEMENT_IF.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Conditional::statementIf($condition, $returnIfTrue, $returnIfFalse);
    }
    /**
     * STATEMENT_SWITCH.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Conditional::statementSwitch(...$arguments);
    }
    /**
     * IFERROR.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Conditional::IFERROR($testValue, $errorpart);
    }
    /**
     * IFNA.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Conditional::IFNA($testValue, $napart);
    }
    /**
     * IFS.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\Logical\Conditional::IFS(...$arguments);
    }
}