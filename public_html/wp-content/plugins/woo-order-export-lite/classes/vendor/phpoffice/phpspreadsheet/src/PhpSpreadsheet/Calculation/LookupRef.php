...
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Address;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\HLookup;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Indirect;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Lookup;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Matrix;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Offset;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\RowColumnInformation;
use WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\VLookup;
...
class LookupRef
{
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Hyperlink::set($linkURL, $displayName, $cell);
    }
    /**
     * INDIRECT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Selection::choose(...$chooseArgs);
    }
    /**
     * MATCH.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\ExcelMatch::MATCH($lookupValue, $lookupArray, $matchType);
    }
    /**
     * INDEX.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\LookupRef\Formula::text($cellReference, $cell);
    }
}