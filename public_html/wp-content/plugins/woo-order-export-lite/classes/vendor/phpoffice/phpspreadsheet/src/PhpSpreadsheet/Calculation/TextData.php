...
class TextData
{
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\CharacterConvert::character($character);
    }
    /**
     * TRIMNONPRINTABLE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Trim::nonPrintable($stringValue);
    }
    /**
     * TRIMSPACES.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Trim::spaces($stringValue);
    }
    /**
     * ASCIICODE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\CharacterConvert::code($characters);
    }
    /**
     * CONCATENATE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Concatenate::CONCATENATE(...$args);
    }
    /**
     * DOLLAR.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::DOLLAR($value, $decimals);
    }
    /**
     * FIND.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Search::sensitive($needle, $haystack, $offset);
    }
    /**
     * SEARCH.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Search::insensitive($needle, $haystack, $offset);
    }
    /**
     * FIXEDFORMAT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::FIXEDFORMAT($value, $decimals, $no_commas);
    }
    /**
     * LEFT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Extract::left($value, $chars);
    }
    /**
     * MID.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Extract::mid($value, $start, $chars);
    }
    /**
     * RIGHT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Extract::right($value, $chars);
    }
    /**
     * STRINGLENGTH.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Text::length($value);
    }
    /**
     * LOWERCASE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\CaseConvert::lower($mixedCaseString);
    }
    /**
     * UPPERCASE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\CaseConvert::upper($mixedCaseString);
    }
    /**
     * PROPERCASE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\CaseConvert::proper($mixedCaseString);
    }
    /**
     * REPLACE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Replace::replace($oldText, $start, $chars, $newText);
    }
    /**
     * SUBSTITUTE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Replace::substitute($text, $fromText, $toText, $instance);
    }
    /**
     * RETURNSTRING.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Text::test($testValue);
    }
    /**
     * TEXTFORMAT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::TEXTFORMAT($value, $format);
    }
    /**
     * VALUE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::VALUE($value);
    }
    /**
     * NUMBERVALUE.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Format::NUMBERVALUE($value, $decimalSeparator, $groupSeparator);
    }
    /**
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Text::exact($value1, $value2);
    }
    /**
     * TEXTJOIN.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Concatenate::TEXTJOIN($delimiter, $ignoreEmpty, ...$args);
    }
    /**
     * REPT.
     *
    ...
    {
        return \WOE\PhpOffice\PhpSpreadsheet\Calculation\TextData\Concatenate::builtinREPT($str, $number);
    }
}