...
class Cells
{
    ...
    private function getUniqueID()
    {
        ...
        return $cacheType instanceof \WOE\PhpOffice\PhpSpreadsheet\Collection\Memory\SimpleCache1 || $cacheType instanceof \WOE\PhpOffice\PhpSpreadsheet\Collection\Memory\SimpleCache3 ? random_bytes(7) . ':' : uniqid('phpspreadsheet.', true) . '.';
    }
    /**
