...
use WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\ConditionalFormatting;
...
class Xls extends BaseReader
{
        ...
        if (!$this->readDataOnly) {
            foreach ($this->objFonts as $objFont) {
                if (isset($objFont->colorIndex)) {
                    $color = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($objFont->colorIndex, $this->palette, $this->version);
            ...
            foreach ($this->spreadsheet->getCellXfCollection() as $objStyle) {
                ...
                if (isset($fill->startcolorIndex)) {
                    $startColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($fill->startcolorIndex, $this->palette, $this->version);
                    $fill->getStartColor()->setRGB($startColor['rgb']);
                }
                if (isset($fill->endcolorIndex)) {
                    $endColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($fill->endcolorIndex, $this->palette, $this->version);
                ...
                if (isset($top->colorIndex)) {
                    $borderTopColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($top->colorIndex, $this->palette, $this->version);
                    $top->getColor()->setRGB($borderTopColor['rgb']);
                }
                if (isset($right->colorIndex)) {
                    $borderRightColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($right->colorIndex, $this->palette, $this->version);
                    $right->getColor()->setRGB($borderRightColor['rgb']);
                }
                if (isset($bottom->colorIndex)) {
                    $borderBottomColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($bottom->colorIndex, $this->palette, $this->version);
                    $bottom->getColor()->setRGB($borderBottomColor['rgb']);
                }
                if (isset($left->colorIndex)) {
                    $borderLeftColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($left->colorIndex, $this->palette, $this->version);
                    $left->getColor()->setRGB($borderLeftColor['rgb']);
                }
                if (isset($diagonal->colorIndex)) {
                    $borderDiagonalColor = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($diagonal->colorIndex, $this->palette, $this->version);
    ...
    private function readXf(): void
    {
        ...
        if (!$this->readDataOnly) {
            ...
            \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellAlignment::horizontal($objStyle->getAlignment(), $horAlign);
            // bit 3, mask 0x08; wrap text
            $wrapText = (0x8 & ord($recordData[6])) >> 3;
            \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellAlignment::wrap($objStyle->getAlignment(), $wrapText);
            // bit 6-4, mask 0x70; vertical alignment
            $vertAlign = (0x70 & ord($recordData[6])) >> 4;
            \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\CellAlignment::vertical($objStyle->getAlignment(), $vertAlign);
            if ($this->version == self::XLS_BIFF8) {
                ...
                if ($bordersLeftStyle = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf & self::getInt4d($recordData, 10)) >> 0)) {
                    $objStyle->getBorders()->getLeft()->setBorderStyle($bordersLeftStyle);
                }
                // bit: 7-4; mask: 0x000000F0; right style
                if ($bordersRightStyle = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf0 & self::getInt4d($recordData, 10)) >> 4)) {
                    $objStyle->getBorders()->getRight()->setBorderStyle($bordersRightStyle);
                }
                // bit: 11-8; mask: 0x00000F00; top style
                if ($bordersTopStyle = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf00 & self::getInt4d($recordData, 10)) >> 8)) {
                    $objStyle->getBorders()->getTop()->setBorderStyle($bordersTopStyle);
                }
                // bit: 15-12; mask: 0x0000F000; bottom style
                if ($bordersBottomStyle = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0xf000 & self::getInt4d($recordData, 10)) >> 12)) {
                ...
                if ($bordersDiagonalStyle = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x1e00000 & self::getInt4d($recordData, 14)) >> 21)) {
                    $objStyle->getBorders()->getDiagonal()->setBorderStyle($bordersDiagonalStyle);
                }
                // bit: 31-26; mask: 0xFC000000 fill pattern
                if ($fillType = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\FillPattern::lookup(((int) 0xfc000000 & self::getInt4d($recordData, 14)) >> 26)) {
                ...
                $objStyle->getFill()->setFillType(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\FillPattern::lookup((0x3f0000 & $borderAndBackground) >> 16));
                // bit: 24-22; mask: 0x01C00000; bottom line style
                $objStyle->getBorders()->getBottom()->setBorderStyle(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x1c00000 & $borderAndBackground) >> 22));
                // bit: 31-25; mask: 0xFE000000; bottom line color
                $objStyle->getBorders()->getBottom()->colorIndex = ((int) 0xfe000000 & $borderAndBackground) >> 25;
                // offset: 12; size: 4; cell border lines
                $borderLines = self::getInt4d($recordData, 12);
                // bit: 2-0; mask: 0x00000007; top line style
                $objStyle->getBorders()->getTop()->setBorderStyle(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x7 & $borderLines) >> 0));
                // bit: 5-3; mask: 0x00000038; left line style
                $objStyle->getBorders()->getLeft()->setBorderStyle(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x38 & $borderLines) >> 3));
                // bit: 8-6; mask: 0x000001C0; right line style
                $objStyle->getBorders()->getRight()->setBorderStyle(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Style\Border::lookup((0x1c0 & $borderLines) >> 6));
    ...
    private function readFormula(): void
    {
        ...
        if ($this->getReadFilter() !== null && $this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            if (ord($recordData[6]) == 0 && ord($recordData[12]) == 255 && ord($recordData[13]) == 255) {
                ...
                $value = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup(ord($recordData[8]));
    ...
    private function readBoolErr(): void
    {
        ...
        if ($this->getReadFilter() !== null && $this->getReadFilter()->readCell($columnString, $row + 1, $this->phpSheet->getTitle())) {
            ...
            switch ($isError) {
                ...
                case 1:
                    // error type
                    $value = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup($boolErr);
                    // add cell value
    ...
    private function readDataValidation(): void
    {
        ...
        $type = (0xf & $options) >> 0;
        $type = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\DataValidationHelper::type($type);
        // bit: 4-6; mask: 0x00000070; error type
        $errorStyle = (0x70 & $options) >> 4;
        $errorStyle = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\DataValidationHelper::errorStyle($errorStyle);
        ...
        $operator = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\DataValidationHelper::operator($operator);
        ...
        if (!$this->readDataOnly) {
            ...
            switch ($sz) {
                case 0x14:
                    ...
                    $color = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($colorIndex, $this->palette, $this->version);
    ...
    private function getNextToken($formulaData, $baseCell = 'A1')
    {
        ...
        switch ($id) {
            ...
            case 0x1c:
                ...
                $name = 'tErr';
                $size = 2;
                $data = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup(ord($formulaData[1]));
                break;
            case 0x1d:
                //    boolean
    ...
    private static function readBIFF8Constant($valueData)
    {
        ...
        switch ($identifier) {
            ...
            case 0x10:
                // error code
                // offset: 1; size: 1; error code
                $value = \WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\ErrorCode::lookup(ord($valueData[1]));
                $size = 9;
                break;
            default:
    ...
    private function getCFFontStyle(string $options, Style $style): void
    {
        ...
        if ($color !== -1) {
            $style->getFont()->getColor()->setRGB(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($color, $this->palette, $this->version)['rgb']);
        }
    }
    ...
    private function getCFFillStyle(string $options, Style $style): void
    {
        ...
        if ($fillPattern !== Fill::FILL_NONE) {
            ...
            $style->getFill()->getStartColor()->setRGB(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($color1, $this->palette, $this->version)['rgb']);
            // bit: 7-13; mask: 0x3F80; type
            $color2 = (0x3f80 & $fillColors) >> 7;
            $style->getFill()->getEndColor()->setRGB(\WOE\PhpOffice\PhpSpreadsheet\Reader\Xls\Color::map($color2, $this->palette, $this->version)['rgb']);
        }
    }
