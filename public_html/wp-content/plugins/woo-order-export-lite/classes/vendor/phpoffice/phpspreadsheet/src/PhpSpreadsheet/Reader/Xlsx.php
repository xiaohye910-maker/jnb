...
class Xlsx extends BaseReader
{
                ...
                foreach ($is->r as $run) {
                    if (!isset($run->rPr)) {
                        ...
                        if (isset($run->rPr->u)) {
                            ...
                            if (!isset($attr['val'])) {
                                $objFont->setUnderline(\WOE\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE);
                            } else {
     ...
     */
    private function readHyperLinkDrawing(\WOE\PhpOffice\PhpSpreadsheet\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, $hyperlinks): void
    {
