    ...
    public static function fromConditional(Conditional $conditional, string $cellRange = 'A1'): WizardInterface
    {
        ...
        switch ($conditionalType) {
            case Conditional::CONDITION_CELLIS:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\CellValue::fromConditional($conditional, $cellRange);
            ...
            case Conditional::CONDITION_ENDSWITH:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\TextValue::fromConditional($conditional, $cellRange);
            case Conditional::CONDITION_CONTAINSBLANKS:
            case Conditional::CONDITION_NOTCONTAINSBLANKS:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\Blanks::fromConditional($conditional, $cellRange);
            case Conditional::CONDITION_CONTAINSERRORS:
            case Conditional::CONDITION_NOTCONTAINSERRORS:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\Errors::fromConditional($conditional, $cellRange);
            case Conditional::CONDITION_TIMEPERIOD:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\DateValue::fromConditional($conditional, $cellRange);
            case Conditional::CONDITION_EXPRESSION:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\Expression::fromConditional($conditional, $cellRange);
            case Conditional::CONDITION_DUPLICATES:
            case Conditional::CONDITION_UNIQUE:
                return \WOE\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\Wizard\Duplicates::fromConditional($conditional, $cellRange);
            default:
                throw new Exception('No wizard exists for this CF rule type');
        }
    }
