...
class AutoFilter
{
    ...
    public function setColumn($columnObjectOrString)
    {
        ...
        } elseif (is_object($columnObjectOrString) && $columnObjectOrString instanceof \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column) {
    ...
    protected static function filterTestInCustomDataSet($cellValue, $ruleSet)
    {
        ...
        $returnVal = $join == \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND;
        foreach ($dataSet as $rule) {
            ...
            switch ($join) {
                case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_OR:
                    ...
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND:
                    $returnVal = $returnVal && $retVal;
                    break;
            }
        }
     ...
     * @return mixed[]
     */
    private function dynamicFilterDateRange($dynamicRuleType, \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column &$filterColumn)
    {
        $ruleValues = [];
        ...
        return ['method' => 'filterTestInCustomDataSet', 'arguments' => ['filterRules' => $ruleValues, 'join' => \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_AND]];
    }
    /**
    ...
    public function showHideRows()
    {
        ...
        foreach ($this->columns as $columnID => $filterColumn) {
            ...
            switch ($filterColumn->getFilterType()) {
                case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_FILTER:
                    $ruleType = null;
                    $ruleValues = [];
                    ...
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_CUSTOMFILTER:
                    ...
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER:
                    $ruleValues = [];
                    foreach ($rules as $rule) {
                        ...
                        if ($dynamicRuleType == Rule::AUTOFILTER_RULETYPE_DYNAMIC_ABOVEAVERAGE || $dynamicRuleType == Rule::AUTOFILTER_RULETYPE_DYNAMIC_BELOWAVERAGE) {
                            ...
                            $columnFilterTests[$columnID] = ['method' => 'filterTestInCustomDataSet', 'arguments' => ['filterRules' => $ruleValues, 'join' => \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_COLUMN_JOIN_OR]];
                    ...
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\AutoFilter\Column::AUTOFILTER_FILTERTYPE_TOPTENFILTER:
                    $ruleValues = [];
