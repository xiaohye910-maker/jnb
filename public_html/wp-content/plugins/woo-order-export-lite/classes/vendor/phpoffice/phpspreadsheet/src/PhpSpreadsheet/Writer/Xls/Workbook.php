...
class Workbook extends BIFFwriter
{
     ...
     * XF Writers.
     *
     * @var \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Xf[]
     */
    private $xfWriters = [];
     ...
     */
    public function addFont(\WOE\PhpOffice\PhpSpreadsheet\Style\Font $font)
    {
     ...
     */
    private function writeBoundSheet(\WOE\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $sheet, $offset): void
    {
        ...
        switch ($sheet->getSheetState()) {
            case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE:
                $ss = 0x00;

                break;
            case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN:
                $ss = 0x01;

                break;
            case \WOE\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN:
                $ss = 0x02;
