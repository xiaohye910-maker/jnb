...
class Worksheet extends BIFFwriter
{
     ...
     * Formula parser.
     *
     * @var \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser
     */
    private $parser;
    /**
     ...
     * Sheet object.
     *
     * @var \WOE\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet
     */
    public $phpSheet;
    /**
     * Escher object corresponding to MSODRAWING.
     *
     * @var null|\WOE\PhpOffice\PhpSpreadsheet\Shared\Escher
     */
    private $escher;
    /**
     ...
     */
    public function __construct(&$str_total, &$str_unique, &$str_table, &$colors, Parser $parser, $preCalculateFormulas, \WOE\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $phpSheet)
    {
     ...
     *
     * @see \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook::storeWorkbook()
     */
    ...
    private function writeCFRule(ConditionalHelper $conditionalFormulaHelper, Conditional $conditional, string $cellRange): void
    {
        ...
        if ($bFormatFont == 1) {
            ...
            switch ($conditional->getStyle()->getFont()->getUnderline()) {
                case \WOE\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_NONE:
                    $dataBlockFont .= pack('C', 0x0);
                    $fontUnderline = 0;
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE:
                    $dataBlockFont .= pack('C', 0x2);
                    $fontUnderline = 0;
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING:
                    $dataBlockFont .= pack('C', 0x22);
                    $fontUnderline = 0;
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE:
                    $dataBlockFont .= pack('C', 0x1);
                    $fontUnderline = 0;
                    break;
                case \WOE\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING:
            ...
            // Font color index
            $colorIdx = \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\ColorMap::lookup($conditional->getStyle()->getFont()->getColor(), 0x0);
        ...
        if ($bFormatAlign === 1) {
            ...
            $blockAlign = \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment::horizontal($conditional->getStyle()->getAlignment());
            $blockAlign |= \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment::wrap($conditional->getStyle()->getAlignment()) << 3;
            $blockAlign |= \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellAlignment::vertical($conditional->getStyle()->getAlignment()) << 4;
            $blockAlign |= 0 << 7;
            // Text rotation angle
        ...
        if ($bFormatBorder === 1) {
            $blockLineStyle = \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getLeft());
            $blockLineStyle |= \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getRight()) << 4;
            $blockLineStyle |= \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getTop()) << 8;
            $blockLineStyle |= \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getBottom()) << 12;
            ...
            $blockColor |= \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellBorder::style($conditional->getStyle()->getBorders()->getDiagonal()) << 21;
            $dataBlockBorder = pack('vv', $blockLineStyle, $blockColor);
        }
        if ($bFormatFill === 1) {
            // Fill Pattern Style
            $blockFillPatternStyle = \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\CellFill::style($conditional->getStyle()->getFill());
            // Background Color
            $colorIdxBg = \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\ColorMap::lookup($conditional->getStyle()->getFill()->getStartColor(), 0x41);
            // Foreground Color
            $colorIdxFg = \WOE\PhpOffice\PhpSpreadsheet\Writer\Xls\Style\ColorMap::lookup($conditional->getStyle()->getFill()->getEndColor(), 0x40);
